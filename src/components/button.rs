...
impl Button {
    ...
    pub fn icon_only(mut self) -> Self {
        self.variant = ButtonVariant::IconOnly;
        self
    }
...
impl RenderOnce for Button {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let (bg, text_color, hover_bg, hover_text) = match (self.variant, self.selected) {
            ...
            (ButtonVariant::IconOnly, _) => (
                Hsla::transparent_black(),
                theme.text,
                theme.surface,
                theme.text,
            ),
            (ButtonVariant::Default, _) => (theme.surface, theme.text, theme.hover, theme.text),
        };
        ...
        let is_icon_only = self.variant == ButtonVariant::IconOnly;
        ...
        div()
            ...
            .items_center()
            .justify_center()
            .when(!is_icon_only, |this| this.gap_2().px_3().py_2().text_sm())
            .when(is_icon_only, |this| this.p_2())
            .rounded_md()
