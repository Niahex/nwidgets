...
use crate::widgets::control_center::service::ControlCenterService;
...
pub struct ControlCenterWidget {
    ...
    pub(in crate::widgets::control_center) control_center: Entity<ControlCenterService>,
    pub(in crate::widgets::control_center) audio: Entity<AudioService>,
    pub(in crate::widgets::control_center) bluetooth: Entity<BluetoothService>,
    pub(in crate::widgets::control_center) network: Entity<NetworkService>,
    pub(in crate::widgets::control_center) notifications: Entity<NotificationService>,
    pub(in crate::widgets::control_center) system_monitor: Entity<SystemMonitorService>,
    pub(in crate::widgets::control_center) sink_dropdown_open: bool,
    pub(in crate::widgets::control_center) source_dropdown_open: bool,
    pub(in crate::widgets::control_center) sink_slider: Entity<SliderState>,
    pub(in crate::widgets::control_center) source_slider: Entity<SliderState>,
    pub(in crate::widgets::control_center) stream_sliders: HashMap<u32, Entity<SliderState>>,
}

pub(in crate::widgets::control_center) fn get_stream_display(
...
impl ControlCenterWidget {
    ...
    pub(in crate::widgets::control_center) fn get_or_create_stream_slider(
        &mut self,
        stream_id: u32,
        initial_volume: u8,
        is_sink_input: bool,
