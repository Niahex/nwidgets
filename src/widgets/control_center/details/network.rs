...
impl super::super::ControlCenterWidget {
    pub(in crate::widgets::control_center) fn render_network_details(
        &mut self,
        cx: &mut Context<Self>,
    ) -> AnyElement {
        let theme = cx.theme();
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(net_state.ssid().unwrap_or_else(|| "Not connected".into())),
                )
                    ...
                    this.child(div().h(px(1.)).bg(theme.hover))
                        ...
                        .child(
                            div().flex().flex_col().gap_2().children(
                                vpn_state.connections.iter().take(6).enumerate().map(
                                    |(idx, vpn)| {
