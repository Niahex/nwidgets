...
This documentation is organized into logical categories for easy AI consumption:

- **core/** - Fundamental concepts and architecture
...
- [Counter App](examples/counter.md)
- [Todo List](examples/todo-list.md)
- [Image Gallery](examples/image-gallery.md)

### Advanced Topics
- [Custom Elements](advanced/custom-elements.md)
...
- [Platform Specific](troubleshooting/platform-specific.md)
